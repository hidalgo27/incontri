module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        beetle:
          "linear-gradient(to right bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/images/banner_1.jpg')",
        beetle2:
          "linear-gradient(to right bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/images/banner_2.jpg')",
        beetle3:
          "linear-gradient(to right bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/images/banner_3.jpg')",
